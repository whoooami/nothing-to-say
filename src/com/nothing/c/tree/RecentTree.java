...
//		System.out.println("RecentTree.�����ϵ�ˣ�"+recentL.toString());
//		System.out.println("RecentTree.�ܹ����û�������"+MapFactory.userMap.size());
		for(String recentID : recentL){
			Users u = MapFactory.userMap.get(recentID);
//			System.out.println("RecentTree.u="+u+"  "+recentID+"�ܹ����û�������"+MapFactory.userMap.size());
			users.add(u);
