...
//			System.out.println("cfID="+cfID+" ubothID="+uID);
	...
	/*public static void ikey(int i){
		Iterator it = hm.keySet().iterator();
		System.out.println("��ǰChatForm������"+hm.size());
		System.out.println("��ǰChatForm�б�");
		while(it.hasNext()){
	...
	/*public static void operaFTCount(String cfid, String op){
		System.out.println(cfid+"�ļ������߳�"+"��ǰFTcount="+getFTCount(cfid));
		int count = 0;
		...
		System.out.println(cfid+"���ĺ��"+"FTcount="+getFTCount(cfid));
	}
