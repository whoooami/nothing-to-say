...
public class SearchResultForm extends MinCloseForm {
	...
	public SearchResultForm(List l, int uorg) {
		...
		super.lbTitle.setText(uorg==0?"������ϵ��":"����Ⱥ");
	...
	public void fillInTable(){
		...
		for(;i<list.size();i++){
			if(uorg == 0){
				...
				model.insertRow(i, new Object[]{i, user.getuID(), user.getuNickName(), user.getuSex()==0?"Ů":"��", user.getuProvice()+" "+user.getuCity()});
			}else{
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(btnName.equals("backBtn")){
				...
				if(friends.indexOf(addID) != -1){
					...
					Tools.alert(SearchResultForm.this, addID+"�Ѿ������ĺ��ѣ�");
				}else{
					...
					if(i>0){
						...
						Tools.alert(SearchResultForm.this, addID+"�Ѿ��ɹ����Ϊ���ĺ��ѣ�");
					}else{
						Tools.alert(SearchResultForm.this, "���ʧ�ܣ��Ժ������ԣ�");
					}
				}
